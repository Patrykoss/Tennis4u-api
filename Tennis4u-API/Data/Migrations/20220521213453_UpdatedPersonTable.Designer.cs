...
namespace Tennis4u_API.Data.Migrations
{
    ...
    [Migration("20220521213453_UpdatedPersonTable")]
            ...
            modelBuilder.Entity("Tennis4u_API.Models.Reservation", b =>
                {
                    ...
                    b.HasIndex("IdTennisCourt", "StartDate", "IdState")
                        .IsUnique();
                    ...
                    b.HasData(
                        ...
                        {
                            IdReservation = 1,
                            EndDate = new DateTime(2022, 5, 7, 14, 0, 0, 0, DateTimeKind.Unspecified),
                            IdState = 1,
                            IdTennisCourt = 1,
                        ...
                        {
                            IdReservation = 5,
                            EndDate = new DateTime(2022, 5, 7, 17, 0, 0, 0, DateTimeKind.Unspecified),
                            IdState = 1,
                            IdTennisCourt = 1,
                            StartDate = new DateTime(2022, 5, 7, 15, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            IdReservation = 6,
                        ...
                        new
                        {
                            ...
                            IdState = 1,
                            IdTennisCourt = 1,
                            StartDate = new DateTime(2022, 5, 8, 18, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            IdReservation = 8,
                            EndDate = new DateTime(2022, 6, 25, 14, 0, 0, 0, DateTimeKind.Unspecified),
                            IdPerson = 6,
                            IdState = 2,
                            IdTennisCourt = 2,
                        ...
                        {
                            IdReservation = 10,
                            EndDate = new DateTime(2022, 6, 30, 20, 0, 0, 0, DateTimeKind.Unspecified),
                            IdPerson = 3,
                            IdState = 2,
                            IdTennisCourt = 3,
                            StartDate = new DateTime(2022, 6, 30, 18, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            IdReservation = 11,
                            EndDate = new DateTime(2022, 5, 5, 14, 0, 0, 0, DateTimeKind.Unspecified),
                            IdPerson = 3,
                            IdState = 1,
                            IdTennisCourt = 3,
                        ...
                        {
                            IdReservation = 12,
                            EndDate = new DateTime(2022, 5, 5, 12, 0, 0, 0, DateTimeKind.Unspecified),
                            IdPerson = 3,
                            IdState = 3,
                            IdTennisCourt = 3,
